...
import { fetchFoodData, fetchFoodDetails } from '../src/api/usdaApi';
import type { FoodDetails, NutrientDetail } from '../src/api/usdaApi';
// If you see "Cannot find module", check that the file exists at ../api/usdaApi.ts or ../api/usdaApi/index.ts
// If the file is named differently (e.g., usdaAPI.ts or usdaApi.tsx), update the import paths accordingly.
import NutrientChart from '../src/components/NutrientChart';
